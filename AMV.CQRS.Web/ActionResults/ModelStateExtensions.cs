...
namespace AMV.CQRS
{
    public static class ModelStateExtensions
    {
        ...
        public static void AddErrorMessage(this ModelStateDictionary modelStateDictionary, ErrorMessage error)
        {
            modelStateDictionary.AddModelError(error.FieldName, error.Message);
        }
